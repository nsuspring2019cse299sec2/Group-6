...
$sql = "INSERT INTO bookinfo (bookname, bookdetails, bookpic, author, publisher, edition, isbn, price, catid, dealid) 
VALUES ('$bookname', '$bookdetails', '$bookpic', '$author', '$publisher', '$edition', '$isbn', '$price', '$catid', '$dealid')";
          ...
          <div class="col-md-6" "col-md-offset-6" style="background-color:light;">
            <div class="page-login-form box">
              ...
              <form method="POST" role="form" class="login-form">
                ...
                <div class="form-group">
                    <input type="number" style="text-align:center" id="#" class="form-control" name="price" placeholder="catid"
                </div>

                <div class="form-group">
                    <input type="number" style="text-align:center" id="#" class="form-control" name="price" placeholder="dealid"
                </div>
...
<div class="col-md-12">
<select name="category-group" id="category-group" class="form-control" required>
<option value="0" selected="selected"> Select a category...</option>
<option value="Vehicles" style="background-color:#E9E9E9;font-weight:bold;" disabled="disabled"> - Engineering -
</option>
<option value="Cars"> CSE</option>
<option value="Commercial vehicles"> EEE</option>
<option value="Motorcycles"> CEE</option>
<option value="Motorcycle Equipment"> Physics and Mathematics
</option>

<option value="House" style="background-color:#E9E9E9;font-weight:bold;" disabled="disabled"> -  Business -
</option>
<option value="Appliances"> Marketing</option>
<option value="Inside"> Finance</option>
<option value="Games"> Human Resource</option>
<option value="Garden"> Economics</option>

<option value="Multimedia" style="background-color:#E9E9E9;font-weight:bold;" disabled="disabled"> - English -
</option>
<option value="Telephony"> ENG102</option>
<option value="Image"> ENG103</option>
<option value="Computers"> ENG105</option>
<option value="Video"> ENG115</option>

<option value="Real" style="background-color:#E9E9E9;font-weight:bold;" disabled="disabled"> - Novels -
</option>
<option value="Apartment"> Bengali Writers</option>
<option value="Home"> Foreign Writers</option>
<option value="Vacation"> Translated</option>
<option value="Commercial"> West Bengal Books</option>


<option value="Services" style="background-color:#E9E9E9;font-weight:bold;" disabled="disabled"> - Religious -
</option>
<option value="Jobs">Islamic</option>
<option value="Job application"> Hindu</option>
<option value="Services"> Buddhism</option>
<option value="Price"> Christianity</option>
...
<option value="Jobs">Exchange</option>
<option value="Job application"> Lend</option>
<option value="Services"> Borrow</option>
<option value="Price"> Sell</option>
<option value="Price"> Buy</option>
