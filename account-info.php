              ...
              <form role="form" class="login-form">
                <div class="form-group">
                  <i class="icon fa fa-user"></i>
                    <input type="text" style="text-align:center" class="form-control" name="username" placeholder="Username" value= "<?php echo $row['username']; ?>"> 
                </div>
                ...
                <button class="btn btn-success" style="background-color:green; margin-bottom: 20px; margin-top: 20px;">Update</button>


              </form>
            </div>
            <a class="btn btn-success" style="background-color: #16a085
; margin-bottom: 20px; margin-top: 20px; margin-right: 5px;" href="all-posts.html">All Books </a>
              <a class="btn btn-success" style="background-color:#16a085; margin-bottom: 20px; margin-top: 20px; margin-left: 5px;" href="account-myads.html"> My Books </a> 
          </div>
